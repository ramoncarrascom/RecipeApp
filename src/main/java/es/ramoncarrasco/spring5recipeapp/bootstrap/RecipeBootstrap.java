package es.ramoncarrasco.spring5recipeapp.bootstrap;

import es.ramoncarrasco.spring5recipeapp.domain.*;
...
/**
 * Bootstrap initialization class for Recipe Application
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        // get Optionals
        UnitOfMeasure eachUom = eachUomOptional.orElseThrow(() -> new RuntimeException("Expected UOM 'Each' not found"));
        UnitOfMeasure teaSpoonUom = teaSpoonOptional.orElseThrow(() -> new RuntimeException("Expected UOM 'Teaspoon' not found"));
        UnitOfMeasure tableSpoonUom = tableSpoonOptional.orElseThrow(() -> new RuntimeException("Expected UOM 'Tablespoon' not found"));
        UnitOfMeasure dashUom = dashUomOptional.orElseThrow(() -> new RuntimeException("Expected UOM 'Dash' not found"));
        UnitOfMeasure pintUom = pintUomOptional.orElseThrow(() -> new RuntimeException("Expected UOM 'Pint' not found"));
        UnitOfMeasure cupUom = cupUomOptional.orElseThrow(() -> new RuntimeException("Expected UOM 'Cup' not found"));
        ...
        // get Optional
        Category americanCategory = americanCategoryOptional.orElseThrow(() -> new RuntimeException("Expected Category 'American' not found"));
        Category mexicanCategory = mexicanCategoryOptional.orElseThrow(() -> new RuntimeException("Expected Category 'Mexican' not found"));
        ...
        guacNote.setRecipeNotes("Simple Guacamole: The simplest version of guacamole is just mashed avocados with salt. Don’t let the lack of availability of other ingredients stop you from making guacamole.\n" +
        ...
        guacRecipe.getIngredients().add(new Ingredient("riped tomato, seeds and pulp removed, chopped", new BigDecimal(.5), eachUom, guacRecipe));
